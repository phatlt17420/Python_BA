...
# Nội dung của Notebook (gồm code và giải thích)
notebook_content = {
 "cells": [
  {
   "cell_type": "markdown",
...
# Tạo file
with open('Phan_Tich_Ngan_Hang_Complete.ipynb', 'w', encoding='utf-8') as f:
    json.dump(notebook_content, f, ensure_ascii=False, indent=1)

print("Đã tạo file: Phan_Tich_Ngan_Hang_Complete.ipynb thành công!")